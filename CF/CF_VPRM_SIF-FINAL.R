...
#Write VPRM Monthly Mean Fluxes to csv file
...
#file.move("VPRM_Fluxes_Monthly_Mean.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")
...
plot <- plot + xlab("Year") + ylab(expression(CO[2]~Fluxes~(mu*mol~m^{-2}~s^{-1}))) + ggtitle(paste("CF Mean Annual Fluxes" ,"(June-October, 2000-2019)"))
...
plot <- plot + scale_y_continuous(breaks=seq(-0.5,2.5,0.5)) #Sets the axis range and interval ("by")
plot <- plot + coord_cartesian(ylim = c(-0.5, 2.5), xlim = c(2000, 2020)) #Forces the limits to be set accordingly
#plot
#save graph to output as high resoultion, Windows compatible format .EMF
fileout <- paste("Line-Final-CF Mean Annual Fluxes","_LineCycle",".emf",sep="")
...
#Move the excel .csv files to the stats folder
#library(filesstrings)
#file.move("VPRM_Fluxes_Annual_Mean.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")
...
plot <- plot + xlab("Year") + ylab(expression(Carbon~Fluxes~(g~C~m^{-2}))) + ggtitle(paste("CF Annual Fluxes" ,"(June-October, 2000-2019)"))
plot <- plot + scale_x_continuous(breaks = seq(from=2000,to=2020,by=2))
#plot <- plot + scale_x_continuous(labels =c("June","July","August","September","October"))
plot <- plot + theme(plot.title = element_text(hjust = 0.5)) #center title
plot <- plot + theme(axis.text=element_text(size=11, face="bold"))
...
plot <- plot + theme(legend.position = "bottom")
plot <- plot + geom_hline(yintercept=0, color="black")
plot <- plot + scale_y_continuous(breaks=seq(-50,250,50)) #Sets the axis range and interval ("by")
plot <- plot + coord_cartesian(ylim = c(-50, 250), xlim = c(2000, 2020)) #Forces the limits to be set accordingly
#plot
#save graph to output as high resoultion, Windows compatible format .EMF
fileout <- paste("Line-Final-CF Annual gC Fluxes","_LineCycle",".emf",sep="")
x11(width=7, height=4) #default dim is 7 #Open new device #2 (note: no #1 because #1 is null)
dev.cur()
plot
savePlot(fileout, "emf", device = dev.cur())
...
#Move the excel .csv files to the stats folder
#library(filesstrings)
#file.move("VPRM_Fluxes_Annual_gC.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")
...
#file.move("Stepwise_Daily_All_Fluxes.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")
#file.move("Stepwise_Annual_All_Fluxes.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")
...
#Bootstrap Measures of Relative Importance (1000 samples)
boot.Annual.ER <- boot.relimp(MultipleReg.model.Annual.ER, b = 1000, type = c("lmg"), rank = TRUE, diff = FALSE, rela = TRUE)
...
#file.move("boot_FINAL_Annual_Fluxes.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")


#save graph to output as high resolution, Windows compatible format .EMF
fileout <- paste("CF_boot_Annual_GPP","_Barplot",".emf",sep="")
...
#save graph to output as high resolution, Windows compatible format .EMF
fileout <- paste("CF_boot_Annual_ER","_Barplot",".emf",sep="")
x11(width=7, height=3.33) #default dim is 7 #Open new device #2 (note: no #1 because #1 is null)
dev.cur()
...
#save graph to output as high resolution, Windows compatible format .EMF
fileout <- paste("CF_boot_Annual_NEE","_Barplot",".emf",sep="")
x11(width=7, height=3.33) #default dim is 7 #Open new device #2 (note: no #1 because #1 is null)
dev.cur()
...
plot <- plot + xlab("Year") + ylab(expression(Carbon~Fluxes~(g~C~m^{-2}))) + ggtitle(paste("CF Annual Flux Anomalies" ,"(June-October, 2000-2019)"))
plot <- plot + scale_x_continuous(breaks = seq(from=2000,to=2020,by=2))
#plot <- plot + scale_x_continuous(labels =c("June","July","August","September","October"))
plot <- plot + theme(plot.title = element_text(hjust = 0.5)) #center title
plot <- plot + theme(axis.text=element_text(size=11, face="bold"))
...
#save graph to output as high resoultion, Windows compatible format .EMF
fileout <- paste("Line-Final-CF Annual Flux gC Anomalies","_Bar",".emf",sep="")
#x11(width=7, height=4) #default dim is 7 #Open new device #2 (note: no #1 because #1 is null)
x11(width=7, height=4) #default dim is 7 #Open new device #2 (note: no #1 because #1 is null)
dev.cur()
...
#file.move("VPRM_Fluxes_Annual_anomaly_gC_Final.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")
...
plot <- plot + xlab("Year") + ylab(expression("Temperature (\u00B0C)")) + ggtitle(paste("CF Annual Temperature Anomalies" ,"(June-October, 2000-2019)"))
plot <- plot + scale_x_continuous(breaks = seq(from=2000,to=2020,by=2))
#plot <- plot + scale_x_continuous(labels =c("June","July","August","September","October"))
plot <- plot + theme(plot.title = element_text(hjust = 0.5)) #center title
plot <- plot + theme(axis.text=element_text(size=11, face="bold"))
...
#save graph to output as high resoultion, Windows compatible format .EMF
fileout <- paste("Line-Final-CF Annual Temperature Anomalies","_Bar",".emf",sep="")
x11(width=7, height=4) #default dim is 7 #Open new device #2 (note: no #1 because #1 is null)
dev.cur()
...
#file.move("VPRM_Temperature_Annual_anomaly_Final.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")
...
plot <- plot + xlab("Year") + ylab(expression(PAR~(mu*mol~m^{-2}~s^{-1}))) + ggtitle(paste("CF Annual PAR Anomalies" ,"(June-October, 2000-2019)"))
plot <- plot + scale_x_continuous(breaks = seq(from=2000,to=2020,by=2))
#plot <- plot + scale_x_continuous(labels =c("June","July","August","September","October"))
plot <- plot + theme(plot.title = element_text(hjust = 0.5)) #center title
plot <- plot + theme(axis.text=element_text(size=11, face="bold"))
...
#save graph to output as high resoultion, Windows compatible format .EMF
fileout <- paste("Line-Final-CF Annual PAR Anomalies","_Bar",".emf",sep="")
x11(width=7, height=4) #default dim is 7 #Open new device #2 (note: no #1 because #1 is null)
dev.cur()
...
#file.move("VPRM_PAR_Annual_anomaly_Final.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")
...
plot <- plot + xlab("Year") + ylab(expression("P & E (mm)")) + ggtitle(paste("CF Annual Total Precip & Evap Anomalies" ,"(June-October, 2000-2019)"))
plot <- plot + scale_x_continuous(breaks = seq(from=2000,to=2020,by=2))
plot <- plot + theme(plot.title = element_text(hjust = 0.5)) #center title
plot <- plot + theme(axis.text=element_text(size=11, face="bold"))
plot <- plot + theme(axis.title=element_text(size=11))
...
#save graph to output as high resoultion, Windows compatible format .EMF
fileout <- paste("Line-Final-CF Annual Total Precip_Evap Anomalies","_Bar",".emf",sep="")
x11(width=7, height=4) #default dim is 7 #Open new device #2 (note: no #1 because #1 is null)
dev.cur()
...
#file.move("VPRM_Precip_Evap_Annual_anomaly_Final.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")
...
plot <- plot + xlab("Year") + ylab(expression("Soil Moisture (mm)")) + ggtitle(paste("CF Annual Soil Moisture Anomalies" ,"(June-October, 2000-2019)"))
plot <- plot + scale_x_continuous(breaks = seq(from=2000,to=2020,by=2))
#plot <- plot + scale_x_continuous(labels =c("June","July","August","September","October"))
plot <- plot + theme(plot.title = element_text(hjust = 0.5)) #center title
plot <- plot + theme(axis.text=element_text(size=11, face="bold"))
...
#save graph to output as high resoultion, Windows compatible format .EMF
fileout <- paste("Line-Final-CF Annual Soil Moisture Anomalies","_Bar",".emf",sep="")
x11(width=7, height=4) #default dim is 7 #Open new device #2 (note: no #1 because #1 is null)
dev.cur()
...
#file.move("VPRM_SoilMoisture_Annual_anomaly_Final.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")
...
plot <- plot + xlab("Year") + ylab(expression("VPD (kPa)")) + ggtitle(paste("CF Annual VPD Anomalies" ,"(June-October, 2000-2019)"))
plot <- plot + scale_x_continuous(breaks = seq(from=2000,to=2020,by=2))
#plot <- plot + scale_x_continuous(labels =c("June","July","August","September","October"))
plot <- plot + theme(plot.title = element_text(hjust = 0.5)) #center title
plot <- plot + theme(axis.text=element_text(size=11, face="bold"))
...
#save graph to output as high resoultion, Windows compatible format .EMF
fileout <- paste("Line-Final-CF Annual VPD Anomalies","_Bar",".emf",sep="")
x11(width=7, height=4) #default dim is 7 #Open new device #2 (note: no #1 because #1 is null)
dev.cur()
...
#file.move("VPRM_VPD_Annual_anomaly_Final.csv", "~/Ecosystem_Modelling/VPRM_POLAR/MODELRUN_FINAL/CF_FINAL/Stats")
